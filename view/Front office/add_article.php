...
<html lang="en">
  ...
  <body>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <form action="add_article.php" method="post" onsubmit="return validateForm()">
          <div class="form-group">
            <label for="titre"><i class="fas fa-heading mr-2"></i>Titre :</label>
            <input type="text" class="form-control" id="titre" name="titre" >
            <span id="titre_error" class="error-message"></span>
          </div>
          <div class="form-group">
            <label for="contenu"><i class="fas fa-file-alt mr-2"></i>Contenu :</label>
          ...
          <div class="form-group">
            <label for="date_article"><i class="fas fa-calendar-alt mr-2"></i>Date de publication :</label>
            <input type="date" class="form-control" id="date_article" name="date_article" >
        ...
        <input type="file" class="form-control" id="image" name="image">
          ...
          <div class="form-group">
            <label for="categorie"><i class="fas fa-tags mr-2"></i>Catégorie :</label>
  ...
  <script>
    function validateForm() {
      ...
      var contentInput = document.getElementById('contenu');
      var authorInput = document.getElementById('auteur');
      var dateInput = document.getElementById('date_article');
      var categoryInput = document.getElementById('categorie');
      var titleError = document.getElementById('titre_error');
      var contentError = document.getElementById('contenu_error');
      var authorError = document.getElementById('auteur_error');
      var dateError = document.getElementById('date_error');
      var categoryError = document.getElementById('categorie_error');
      ...
      // Valide l'auteur
      if (!authorValue.trim()) {
        authorError.textContent = 'L\'auteur est requis.';
        return showAlert('Veuillez remplir tous les champs.');
      }

      // Valide la date
      if (!dateValue.trim()) {
        dateError.textContent = 'La date de publication est requise.';
        return showAlert('Veuillez remplir tous les champs.');
      }

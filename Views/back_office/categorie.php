...
require_once __DIR__ . '../../../Controls/job_management/categoryC.php';
                        ...
                        <div class="card-body">
                            ...
                            <form id="addCategoryForm" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name_category" name="name_category" placeholder="Enter  name category" >
                                    <span id="name_category_error" class="text-danger"></span> <!-- Error message placeholder -->
                                </div>
                                <div class="mb-3">
                                    <label for="description_category" class="form-label">description *</label>
                                    <input type="text" class="form-control" id="description_category" name="description_category" placeholder="Enter description category" >
                                    <span id="description_category_error" class="text-danger"></span> <!-- Error message placeholder -->
                                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form id="updateCategoryForm" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="update_category_id" name="category_id" readonly>
                                </div>
                          
                                <div class="mb-3">
                                    <label for="update_name_category" class="form-label">name_category *</label>
                                    <input type="text" class="form-control" id="update_name_category" name="category_name" placeholder="Enter  name category" >
                                ...
                                <tbody>
                                    <?php foreach ($categorys as $cat) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-warning btn-sm edit-btn" data-category-id="<?= $cat['id_category'] ?>" data-category-name="<?=  $cat['name_category']  ?>" data-description="<?= $cat['description_category'] ?>"  >Edit</button>

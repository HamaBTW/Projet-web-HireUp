...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/subs_inputC.css">
...
<body>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a class="btn btn-primary mb-3 ms-3" href="./feature/featureMg.php?profile_id=<?php echo $test ?>" style="font-size: large;">
    ...
    <script src="../../assets/js/inputC_subsAdd.js"></script>

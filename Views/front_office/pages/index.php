                  ...
                  <div class="col-sm-12">
                    <div class="intro_layers_wrapper">
                      <div class="intro_layers">
                        ...
                        <div class="intro_layer" data-animation="fadeIn">
                          <div class="d-inline-block">
                            <button type="button" class="btn btn-outline-maincolor center-block">
                              Join Our HU
                            </button>
                          </div>
                        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 col-lg-6 animate" data-animation="slideInLeft">
              <div class="heading-about">
                ...
                <p>
                  ...
                  business. We feel that this specialist part of HR is often
            ...
            <div class="col-md-12 col-lg-6 animate" data-animation="slideInRight">
              <img src="../assets/images/person01.jpg" alt="person01.jpg" />
            </div>
          </div>
        </div>
      </section>
              ...
              <form class="ds contact-form c-mb-20">
                ...
                <div class="col-sm-12">
                  <div class="form-group text-center">
                    <button type="submit" id="contact_form_submit" name="contact_submit" class="button">
                      Submit CV
                    </button>
                  </div>
                </div>
              ...
              <div class="owl-carousel pt-30" data-responsive-lg="3" data-responsive-md="2" data-responsive-sm="2" data-nav="false" data-dots="false">
                <?php foreach ($jobs as $job) : ?>
                  <div class="item">
                    ...
                    <?php endif; ?>
                    <article class="box vertical-item text-center content-padding padding-small bordered post type-post status-publish format-standard has-post-thumbnail sticky position-relative">

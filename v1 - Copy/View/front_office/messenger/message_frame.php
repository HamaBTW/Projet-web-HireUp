...
<body>
    ...
    <div class="conversation-top">
                        ...
                        <div class="conversation-user">
                            <img class="conversation-user-image" src="data:image/jpeg;base64,<?= base64_encode($profile['profile_photo']) ?>" alt="">
                            <div>
                                <div class="conversation-user-name"><?php echo $profile['profile_first_name'] . " " . $profile['profile_family_name']; ?></div>

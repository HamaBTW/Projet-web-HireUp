              ...
              <form id="profileForm" method="post">
                <div class="card-body" id="step1">
                  ...
                  <div class="mb-3">
                    ...
                    <div class="input_field">
                      <input type="text" onkeyup="validateFName()" class="form-control" id="profile_first_name" name="profile_first_name" placeholder="Enter first name" required />
                  ...
                  <div class="mb-3">
                    ...
                    <div class="input_field">
                      <input type="text" onkeyup="validateLName()" class="form-control" id="profile_family_name" name="profile_family_name" placeholder="Enter family name" required />
                  ...
                  <div class="mb-3">
                    ...
                    <div class="position-relative">
                      <input type="date" onchange="validateBDay()" class="form-control" id="profile_bday" name="profile_bday" />
                  ...
                  <button onclick="validateStep1(); return false;" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2" >Continue</button>
                </div>
                <div class="card-body d-none" id="step2">
                  ...
                  <div class="mb-3">
                    ...
                    <div class="input_field">
                      <input type="text" onkeyup="validateRegion()" class="form-control" id="profile_region" name="profile_region" placeholder="Enter country/region" />
                  ...
                  <div class="mb-3">
                    ...
                    <div class="input_field">
                      <input type="text" onkeyup="validateCity()" class="form-control" id="profile_city" name="profile_city" placeholder="Enter city" />
                  ...
                  <div class="mb-3">
                    ...
                    <div class="input_field">
                      <input type="text" onkeyup="validatePos()" class="form-control" id="profile_current_position" name="profile_current_position" placeholder="Enter current position" />
                  ...
                  <div class="mb-3">
                    ...
                    <div class="input_field">
                      <input type="text" onkeyup="validateEdu()" class="form-control" id="profile_education" name="profile_education" placeholder="Enter education" />
                      <span id="edu_error"></span>
                    </div>
                  </div>

                  <button onclick="return validateForm()" id="submit_button" class="btn btn-primary w-100 py-2 fs-4 mb-4 rounded-2">Confirm</button>

...
?>
            ...
            <div class="container-xl px-4 mt-4">
                ...
                <nav class="nav nav-borders">
                    <a class="nav-link active ms-0" href="edit-profile.php?profile_id=<?php echo $profile['profile_id'] ?>">Profile</a>
                            ...
                            <div class="card-body">
                                <form id="profileForm" action="./update.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="inputUsername" type="text" placeholder="Enter your username" value="<?php echo isset($user_infos['user_name']) ? $user_infos['user_name'] : ''; ?>" disabled>
                                    </div>
                                    <!-- Form Row-->
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="profile_first_name" placeholder="Enter your first name" name="profile_first_name" value="<?php echo isset($profile['profile_first_name']) ? $profile['profile_first_name'] : ''; ?>"  />
                                        </div>
                                        <!-- Form Group (last name)-->
                                        <div class="col-md-6">
                                            <label class="small mb-1" for="inputLastName">Last name</label>
                                            <input type="text" class="form-control" id="profile_family_name" placeholder="Enter your last name" name="profile_family_name" value="<?php echo isset($profile['profile_family_name']) ? $profile['profile_family_name'] : ''; ?>"  />
                                        </div>
                                    </div>
                                    <!-- Form Group (email address)-->
                                    <div class="mb-3">
                                        <label class="small mb-1" for="inputEmailAddress">Email address</label>
                                        <input class="form-control" id="inputEmailAddress" type="email" placeholder="Enter your email address" value="<?php echo isset($user_infos['email']) ? $user_infos['email'] : ''; ?>" disabled>
                                    </div>
                                    <!-- Form Group (phone number)-->
                                    <div class="mb-3">
                                        <label class="small mb-1" for="inputEmailAddress">Phone Number</label>
                                        <input class="form-control" id="old_profile_phone_number" type="text" value="<?php echo isset($profile['profile_phone_number']) ? $profile['profile_phone_number'] : ''; ?>" disabled>
                                    </div>
                                    <!-- Form Row-->
                                    <div class="row gx-3 mb-3">
                                        <!-- Form Group (Gender)-->
                        ...
                        <div class="card mb-4 mb-xl-0">
                            ...
                            <div class="card-body text-center">
                                ...
                                <form id="profileFormPhone" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <input type="text" class="form-control phone_nb_to_change" id="profile_phone_number" placeholder="Enter Phone Number..." name="update_profile_phone_number">
                                    </div>-
            ...
            <div class="verification-modal">
                <form class="form verification-form" id="verifCodeForm" action="./update-phone.php?profile_id=<?php echo $profile['profile_id']; ?>" method="POST">
                    ...
                    <div class="action-btns">
                        <button type="submit" id="verifyButton" class="verify" onclick="changeActionForPhoneNbUpdate()" disabled>Verify</button>

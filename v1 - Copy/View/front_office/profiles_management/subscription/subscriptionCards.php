        ...
        <div class="container-fluid">
            ...
            <div class="dropdown ms-auto">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
                    ...
                    <li><a class="dropdown-item" href="../profile-settings-privacy.php?profile_id=<?php echo $profile['profile_id'] ?>">Settings
                            & Privacy</a></li>
                    ...
                    <div class="row justify-content-center">
                        <?php foreach ($groupedSubscription as $subscriptionIndex => $subscription) : ?>
                            ...
                            <div class="col-12 col-sm-8 col-md-6 col-lg-5">
                                <div class="single_price_plan <?php echo strtolower($card); ?> wow fadeInUp" data-wow-delay="0.2s">

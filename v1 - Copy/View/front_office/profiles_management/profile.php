    ...
    <div class="container-fluid">
      ...
      <div class="dropdown d-flex align-items-center">
        ...
        <div class="d-flex">
          ...
          <div class="dropdown">
            <button class="btn rounded_button_bar me-3" id="followRequestsDropdown" data-bs-toggle="dropdown" aria-expanded="false">
              <i class="fa fa-user-plus"></i>
            </button>
            <!-- Follow Requests Dropdown Menu -->
            <!-- Follow Requests Dropdown Menu -->
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="followRequestsDropdown" id="followRequestDropdown">
              <!-- Dropdown Header -->
              ...
              <li>
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <img src="example-profile-photo.jpg" alt="Profile Photo" class="rounded-circle me-2" width="30" height="30">
                  <div>
                    <strong>John Doe</strong> wants to follow you.
                  </div>
                  
                  <div class="ms-auto">
                    <button class="btn btn-sm btn-primary rounded-3 me-1"><i class="fas">&#xF055;</i></button>
                    <button class="btn btn-sm btn-danger rounded-3"><i class="fas">&#xf057;</i></button>
                  </div>
                </a>
              </li>

    ...
    public function generateRecOptions()
{
    ...
    $sql = "SELECT id, id_user FROM reclamations";
    ...
    try {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            $options .= '<option value="' . $row['id'] . '">' . $row['id'] . ' - ' . $row['id_user'] . '</option>';
        }
...
public function generateRecOptionsSelected($id)
{
    ...
    try {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            if ($id == $row['id']){
                $options .= '<option selected value="' . $row['id'] . '">' . $row['id'] . ' - ' . $row['id_user'] . '</option>';
            }
            else{
                $options .= '<option value="' . $row['id'] . '">' . $row['id'] . ' - ' . $row['id_user'] . '</option>';
            }

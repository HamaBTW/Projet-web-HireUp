                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-bottom-0">
                                                ...
                                                <button type="button" class="btn btn-danger btn-sm me-2" onclick="window.location.href = './update_dmd.php?id=<?= $dmd['iddemande']; ?>';">update</button>
                                                <button type="button" class="btn btn-danger btn-sm me-2" onclick="window.location.href = './generate_pdf.php?id=<?= $dmd['iddemande']; ?>';">PDF</button>
                                                <button type="button" class="btn btn-danger btn-sm me-2" onclick="window.location.href = './accepter.php?id=<?= $dmd['iddemande']; ?>';">accepter</button>

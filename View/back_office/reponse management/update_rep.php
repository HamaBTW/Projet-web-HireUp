                        ...
                        <div class="card-body">
                            ...
                            <form action="./update.php?id=<?php echo $reponse['id']; ?>" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="<?= $reponse['contenu']; ?>" id="contenu" name="contenu"
                                ...
                                <label for="id_reclamation"><b>ID reclamation</b></label>
                                    <select class="form-control" id="id_reclamation" name="id_reclamation" required>
                                ...
                                <!-- Submit Button -->
                                <button type="submit" class="btn btn-primary" onclick="return verif_reponse_managemet_inputs()">Update Answer</button>

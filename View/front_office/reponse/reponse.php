				...
				<div class="container ">
					<div class="row">
						...
						<div class="col-lg-8 offset-lg-2 animate" data-animation="slideDown">
							...
							<form class="black-bg c-mb-20 c-gutter-20" method="post" action="../../../View/back_office/reponse management/add_rep_front.php">

								<div class="row">

									<div class="col-sm-6">
										<div class="ds form-group has-placeholder">
											<label for="id_reclamation">Reclamation ID
												<span class="required">*</span>
											</label>
											<input type="text" aria-required="true" size="30" value="" name="id_reclamation" id="id_reclamation" class="form-control" placeholder="Reclamation ID">
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="ds form-group has-placeholder">
											...
											<textarea aria-required="true" rows="6" cols="4" name="contenu" id="contenu" class="form-control" placeholder="contenu"></textarea>
											<div id="id_user_error" style="color: red;"></div>
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-sm-12 text-center mt-10">
										...
										<div class="form-group">
											<button type="submit" id="add_btn" name="add_btn" class="btn-color" onclick="return verif_reponse_managemet_inputs_front()">
												Send Now
											</button>

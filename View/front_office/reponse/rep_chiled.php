...
if (isset($_GET['id'])){
	...
	$rep_list = $repC->listRepByIdec($current_id);
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="ds form-group has-placeholder">
											...
											<input type="text" aria-required="true" size="30" value=<?php echo $rep['date_reponse'] ; ?> name="date" id="date" class="form-control" placeholder="Status" readonly>
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="ds form-group has-placeholder">
											...
											<textarea aria-required="true" rows="6" cols="4" name="description" id="description" class="form-control" placeholder="Description" readonly><?php echo $rep['contenu'] ; ?></textarea>

				...
				<div class="container ">
					...
					<div id="alertContainer"></div>
						...
						<div class="col-lg-8 offset-lg-2 animate" data-animation="slideDown">
							...
							<form class="black-bg c-mb-20 c-gutter-20" method="post" action="../../../View/back_office/reclamations managment/add_rec_front.php">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="ds form-group has-placeholder">
											...
											<input type="text" aria-required="true" size="30" value="" name="sujet" id="sujet" class="form-control" placeholder="Subject">
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="ds form-group has-placeholder">
											...
											<textarea aria-required="true" rows="6" cols="4" name="description" id="description" class="form-control" placeholder="Description"></textarea>
								...
								<div class="row">
									...
									<div class="col-sm-12 text-center mt-10">
										...
										<div class="form-group">
											<button type="submit" id="add_btn" name="add_btn" class="btn-color" onclick="return verif_reclamation_managemet_inputs_front()">
												Send Now
											</button>

...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<section class="page_toplogo ls s-py-25">
				...
				<div class="container ">
					...
					<div class="divider-30 d-none d-xl-block"></div>
						...
						<div class="col-lg-8 offset-lg-2 animate" data-animation="slideDown">
							...
							<form class="black-bg c-mb-20 c-gutter-20" method="post" action="">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="ds form-group has-placeholder">
											...
											<input type="text" aria-required="true" size="30" value=<?php echo $rec['sujet'] ; ?> name="sujet" id="sujet" class="form-control" placeholder="Subject" readonly>
									...
									<div class="col-sm-6">
										<div class="ds form-group has-placeholder">
											<label for="id_user">statut
												<span class="required">*</span>
											</label>
											<input type="text" aria-required="true" size="30" value=<?php echo $rec['date_creation'] ; ?> name="date" id="date" class="form-control" placeholder="Status" readonly>
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="ds form-group has-placeholder">
											...
											<textarea aria-required="true" rows="6" cols="4" name="description" id="description" class="form-control" placeholder="Description" readonly><?php echo $rec['description'] ; ?></textarea>
								...
								<div class="col-sm-6">
										<div class="ds form-group has-placeholder">
											<label for="sujet">Date
												<span class="required">*</span>
											</label>
											<input type="text" aria-required="true" size="30" value=<?php echo $rec['statut'] ; ?> name="statut" id="statut" class="form-control" placeholder="date" readonly>
											<div id="sujet_error" style="color: red;"></div>
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-sm-12 text-center mt-10">
										...
										<div class="form-group">
											<button type="button" id="add_btn" name="add_btn" class="btn-color" onclick="window.location.href='./../reponse/rep_chiled.php?id=<?php echo $rec['id'] ; ?>'">
												View
											</button>

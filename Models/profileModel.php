...
class ProfileModel
{
    ...
    public function getProfileBday()
    {
        return $this->profile_bday;
    }

    public function setProfileBday($profile_bday)
    {
        $this->profile_bday = $profile_bday;
    }
    ...
    public function setProfileGender($profile_gender)
    {
